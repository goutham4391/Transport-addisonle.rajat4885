...
(function($, window, document, undefined) {
    $.fn.socialfeed = function(_options) {
        ...
        var defaults = {
            ...
            template: '/wp-content/themes/addlee/templates/content/twitter-feed.html', // a path to the template file
                    ...
                    utility: {
                        ...
                        unifyPostData: function(element) {
                            ...
                            if (element.id) {
                                ...
                                post.author_handle = '@' +element.user.screen_name;
                                post.author_picture = element.user.profile_image_url.replace('http://','https://');
                                post.post_id = element.id_str;
                                post.tw_reply = '<a href="https://twitter.com/intent/tweet?in_reply_to=' + element.id_str + '" class="icon-reply" target="_blank">Reply</a>';
